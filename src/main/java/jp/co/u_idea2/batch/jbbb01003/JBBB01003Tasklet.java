...
public class JBBB01003Tasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        try {
            ...
            for (FareTypeAggregationResultDto inputData : items) {
                ...
                try {
                    ...
                    // ファイル書込みエラー（100:異常終了）
                    LOGGER.error(LogMessages.E_AR_common_L9001.getMessage(outputFilePath), e);
                    contribution.setExitStatus(new ExitStatus("BUSINESS_ERROR"));
                    return RepeatStatus.FINISHED;
                }
        ...
        LOGGER.info(LogMessages.I_AR_common_L0003.getMessage(outputFilePath, outputLineCount));
